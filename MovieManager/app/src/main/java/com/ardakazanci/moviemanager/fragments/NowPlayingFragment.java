package com.ardakazanci.moviemanager.fragments;
...
import com.ardakazanci.moviemanager.adapters.MovieRecyclerViewAdapter;
...
public class NowPlayingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_now_playing, container, false); // Yüklencek arayüz.


        unbinder = ButterKnife.bind(this, view); // RecyclerView referansı
        initializeData(); // Yüklenecek veriler.
        MovieRecyclerViewAdapter movieRecyclerViewAdapter = new MovieRecyclerViewAdapter(this.getContext(), movies);
        // Doğrusal düzen yöneticisi
    ...
    // Filmlerin nesne olarak List Koleksiyonuna eklenmesini sağlayan metot.
